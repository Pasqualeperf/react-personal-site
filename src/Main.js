            ...
            <div className="container position-relative">
                <div className="row justify-content-center">
                    ...
                    <div className="col-12 col-md-7 d-flex flex-column align-items-center">
                        <h2 className="title display-2 text-center">Howdy!</h2>
                        <p className="text text-justified">
                            Sono{" "}
                            <a
                            href="https://www.linkedin.com/in/pasquale-perfetto-214ab513a/"
                            target="_blank"
                            rel="noreferrer"
                            >
                            ...
                            {" "}e sei qui per reclutarmi giusto?...Ah no?!
                            <br />
                            Ho capito, sei qui perchè sicuramente avrai sentito parlare di me o
                            visto qualche mio lavoro.
                            <br />
                            Sei una persona dai buoni gusti, contattami qui:
                            <br />
                            ---&gt;
                            <a itemProp="email" href="mailto:pasquale.perf@gmail.com">
                            pasquale.perf@gmail.com
                            </a>
                            &lt;---
                        </p>
                ...
                <div className="socialContainer position-absolute">
                    ...
                    <div className="secondSocial">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            href="https://github.com/Pasqualeperf?tab=repositories"
                        >
                            <svg
                                id="githubIcon"
                                fill="#000000"
